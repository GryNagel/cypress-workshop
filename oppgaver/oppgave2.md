...
For å kunne skrive ts i Cypress testene trenger vi å legge inn egen eslint og ts config. Lag to nye filer i `/cypress`: `tsconfig.json` og `.eslintrc` og legg inn innholder herfra: 
